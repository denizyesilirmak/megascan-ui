        ...
        <div className="top">
          ...
          <div className="auto-lrl-settings-part">
            ...
            <svg width="80" height="80" xmlns="http://www.w3.org/2000/svg">
              ...
              <g>
                <path  stroke={this.map(this.props.depth, this.props.limits.MINDEPTH, this.props.limits.MAXDEPTH, 0, 5) >= 0 ? "#fcba03" : "#333"} transform="rotate(90 40.00000762939453,7.871353149414067) " id="svg_15" d="m36.8371,-3.52863c0,0 13.82419,9.57576 0.6,22.79996" stroke-width="4" fill="none" />
                <path  stroke={this.map(this.props.depth, this.props.limits.MINDEPTH, this.props.limits.MAXDEPTH, 0, 5) >= 1 ? "#fcba03" : "#333"} transform="rotate(90 40.00000000000001,17.87132072448731) " id="svg_16" d="m35.23217,0.68671c0,0 20.83892,14.43473 0.90445,34.36922" stroke-width="4" fill="none" />
                <path  stroke={this.map(this.props.depth, this.props.limits.MINDEPTH, this.props.limits.MAXDEPTH, 0, 5) >= 2 ? "#fcba03" : "#333"} transform="rotate(90 40.00000000000001,27.377464294433597) " id="svg_17" d="m33.38032,3.51827c0,0 28.93285,20.04126 1.25575,47.71838" stroke-width="4" fill="none" />
                <path  stroke={this.map(this.props.depth, this.props.limits.MINDEPTH, this.props.limits.MAXDEPTH, 0, 5) >= 3 ? "#fcba03" : "#333"} transform="rotate(90 40,38.3650817875938) " id="svg_18" d="m31.77539,8.72126c0,0 35.94759,24.90024 1.5602,59.28765" stroke-width="4" fill="none" />
                <path  stroke={this.map(this.props.depth, this.props.limits.MINDEPTH, this.props.limits.MAXDEPTH, 0, 5) >= 4 ? "#fcba03" : "#333"} transform="rotate(90 40,49.84651947021485) " id="svg_19" d="m30.41737,15.80183c0,0 41.88314,28.59688 1.81782,68.08938" stroke-width="4" fill="none" />
                <path  stroke={this.map(this.props.depth, this.props.limits.MINDEPTH, this.props.limits.MAXDEPTH, 0, 5) >= 5 ? "#fcba03" : "#333"} transform="rotate(90 40.00000000000001,62.56252670288086) " id="svg_6" d="m30.047,26.6891c0,0 43.50192,30.13298 1.88808,71.74685" stroke-width="4" fill="none" />
              </g>
            </svg>
